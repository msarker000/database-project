...
public class FunctionDependency {
	...
	private  Set<Character> attributesOfRhsOfFD = new TreeSet<Character>();
	...
	public FunctionDependency(Set<Character> lhsOfFD, Character rhsOfFD) {
	...
	public FunctionDependency(Set<Character> lhsOfFD, Set<Character> rhsOfFD) {
