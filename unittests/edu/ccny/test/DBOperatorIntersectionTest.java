...
public class DBOperatorIntersectionTest {
	...
	public void testIntersection() {
		...
		Set<Tuple> tuples1 =  dbOperator.select("Student", conditions, DBOperator.LOGICAL.AND);
		printTuples(tuples1);
		...
		System.out.println("-------------------------------");
		Set<Tuple> tuples2 =  dbOperator.select("Student", conditions, DBOperator.LOGICAL.OR);
		printTuples(tuples2);
		
		// find the student  whose roll between 100 and 130 and department code 1001 or 1004
		System.out.println("--------------intersection of two sets of tuple-----------------");
		Set<Tuple> intersectTuples  = dbOperator.intersection(tuples1, tuples2);
		printTuples(intersectTuples);
